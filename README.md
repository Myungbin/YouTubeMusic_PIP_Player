...
- PIP 창 키보드 단축키와 마우스 휠 볼륨 조절
- 다음 곡 미리보기와 재생목록 패널 (곡을 눌러 바로 재생)
...
| `Space` | 재생/일시정지 |
| `←` / `→` | 5초 뒤로/앞으로 |
| `↑` / `↓` 또는 마우스 휠 | 볼륨 5% 올리기/내리기 |
| `N` / `P` | 다음/이전 곡 |
| `M` | 음소거 전환 |
| `Q` | 재생목록 열기/닫기 (`Esc`로 닫기) |
...
- PIP 창 단축키와 마우스 휠 볼륨 조절이 동작하고, PIP 볼륨이 YouTube Music 볼륨 슬라이더와 일치하는지 확인
- 다음 곡 미리보기가 셔플/곡 변경 후에도 맞는지, 재생목록 패널에서 곡을 누르면 해당 곡이 재생되는지 확인
